      ...
      <div className="flex flex-col justify-center gap-4 h-screen p-4 md:px-8">
        ...
        <form className="flex flex-col gap-2">
          <div className="flex flex-row items-center gap-1 px-2 py-1 border border-slate-200 rounded-md focus-within:ring-2 focus-within:ring-violet-900">
            ...
            <input id="name" name="name" type="name" placeholder="Seu nome e sobrenome" className="w-full text-slate-700 placeholder:text-slate-500 outline-none focus:outline-none focus-visible:ring-0 px-2 py-1" autoComplete="email" required />
          </div>
          <div className="flex flex-row items-center gap-1 px-2 py-1 border border-slate-200 rounded-md focus-within:ring-2 focus-within:ring-violet-900">
          ...
          <div className="flex flex-row items-center gap-1 px-2 py-1 border border-slate-200 rounded-md focus-within:ring-2 focus-within:ring-violet-900" >
            ...
            <Lock size={20} className="text-slate-500" />
            <input id="confirm-password" name="confirm-password" type={isVisible ? "text" : "password"} placeholder="Confirme sua senha" className="w-full text-slate-700 placeholder:text-slate-500 outline-none focus:outline-none focus-visible:ring-0 px-2 py-1" autoComplete="password" required />
            <button type="button" className="hover:cursor-pointer outline-none focus-within:outline-none focus-within:ring-0" onClick={handlePasswordVisible}>
              {isVisible ? 
                <Eye size={20} className="text-slate-500" /> : 
                <EyeClosed size={20} className="text-slate-500" />
        ...
        <div className="flex flex-col gap-3">
          <LaminatedButton>Criar conta</LaminatedButton>
          <div className="flex flex-row items-center gap-2">
            <span className="border-t border-slate-300 flex-1"></span>
            <span className="text-slate-500 text-sm font-normal font-ubuntu">Ja possui uma conta?</span>
          ...
          <span className="text-slate-500 text-center text-xs">Ao continuar, voce concorda com os <a href="/" className="text-violet-900 font-bold font-ubuntu underline cursor-pointer" rel="noopener noreferrer">Termos de Servico</a> e a <a href="/" className="text-violet-900 font-bold font-ubuntu underline cursor-pointer" rel="noopener noreferrer">Politica de Privacidade</a></span>
        </div>
      </div>
    </>
  );
